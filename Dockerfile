...
# Install Swift
RUN curl -O https://swift.org/builds/swift-5.0.3-release/ubuntu1604/swift-5.0.3-RELEASE/swift-5.0.3-RELEASE-ubuntu16.04.tar.gz \
    && tar xzvf swift-5.0.3-RELEASE-ubuntu16.04.tar.gz

ENV PATH ${WORKDIR}/swift-5.0.3-RELEASE-ubuntu16.04/usr/bin:$PATH
ENV C_INCLUDE_PATH ${WORKDIR}/swift-5.0.3-RELEASE-ubuntu16.04/usr/lib/swift/clang/include/
